...
int main()
{
    ...
    cout << "Address of first element of arr[0] pointing to ptr-> " << &arr << endl; //&arr represents the memory address where the array starts. In C++, this is numerically the same as the address of the first element (&arr[0]), but it refers to the entire array block.
